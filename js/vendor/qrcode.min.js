/*
 * QR Code Generator for JavaScript — vendored, not fetched at runtime.
 *
 * Source:  qrcode-generator v2.0.4 (dist/qrcode.mjs)
 * Author:  Kazuhiko Arase — http://www.d-project.com/
 * Licence: MIT
 *
 * Vendored into js/vendor/ because the school PC has no internet and nothing in
 * this app may reach a CDN. Do not edit; replace wholesale to upgrade.
 * See js/qr.js for the wrapper this app actually calls.
 */
//---------------------------------------------------------------------
//
...
export const qrcode = function(typeNumber, errorCorrectionLevel) {
  ...
  _this.createASCII = function(cellSize, margin) {
    ...
    const white = Array(cellSize+1).join('â–ˆâ–ˆ');
